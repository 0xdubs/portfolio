        ...
        <StaggerChildren>
          ...
          >
            {companies.map((company, index) => (
              <MotionBox cursor={'pointer'} whileHover={{ y: -5 }} key={index} onClick={()=> window.open(company.url)}>
                <Card
                  key={index}
                  title={company.title}
                  role={company.role}
          ...
          >
            {institutes.map((institute, index) => (
              <MotionBox cursor={'pointer'} whileHover={{ y: -5 }} key={index} onClick={()=> window.open(institute.url)}>
                <Card
                  key={index}
