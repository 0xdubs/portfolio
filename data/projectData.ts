export const projectsList = [
  ...
  {
    title: 'HashHost',
    imageLight: '/assets/images/projects/hashhost.jpg',
    blurHash: 'L4ADc400P*Zi4Tu1y;Qo00pH#YXl',
    site: 'https://hashhost-pi.vercel.app/',
    description:
      'Hashhost is a web app used to monitor all bitcoin-mining data.',
    techStack: ['Vercel','Heroku', 'React', 'Typescript']
  },
